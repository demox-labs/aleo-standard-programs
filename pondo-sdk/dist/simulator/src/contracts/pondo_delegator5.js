...
export class pondo_delegator5Program {
    ...
    finalize_bond(validator) {
        ...
        let balance = BigInt.asUintN(64, this.credits.account.get('pondo_delegator5.aleo'));
    ...
    finalize_unbond() {
        ...
        let bonded = this.credits.bonded.has('pondo_delegator5.aleo');
    ...
    finalize_terminal_state() {
        let bonded = this.credits.bonded.has('pondo_delegator5.aleo');
        assert(bonded === false, 'Ensure the delegator was completely unbonded');
        let is_unbonding = this.credits.unbonding.has('pondo_delegator5.aleo');
