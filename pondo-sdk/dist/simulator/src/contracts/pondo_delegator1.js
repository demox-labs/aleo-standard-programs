...
export class pondo_delegator1Program {
    ...
    //program pondo_delegator1.aleo {// There are 4 potential states for a delegator:
    ...
    bond(validator, amount) {
        ...
        this.credits.caller = 'pondo_delegator1.aleo';
        this.credits.bond_public(validator, 'pondo_delegator1.aleo', amount);
    ...
    finalize_bond(validator) {
        ...
        let balance = BigInt.asUintN(64, this.credits.account.get('pondo_delegator1.aleo'));
    ...
    unbond(amount) {
        ...
        this.credits.signer = this.signer;
        this.credits.caller = 'pondo_delegator1.aleo';
        this.credits.unbond_public('pondo_delegator1.aleo', amount);
        return this.finalize_unbond();
    }
    finalize_unbond() {
        // Should be entirely unbonded
        let bonded = this.credits.bonded.has('pondo_delegator1.aleo');
    ...
    finalize_terminal_state() {
        let bonded = this.credits.bonded.has('pondo_delegator1.aleo');
        assert(bonded === false, 'Ensure the delegator was completely unbonded');
        let is_unbonding = this.credits.unbonding.has('pondo_delegator1.aleo');
    ...
    ban_validator(validator) {
        ...
        this.pondo_oracle.caller = 'pondo_delegator1.aleo';
