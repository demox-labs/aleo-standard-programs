...
import { depositPublic, instantWithdraw, LiveRpcProvider, TestRpcProvider } from './index.js';
...
async function testDepositPublic() {
    ...
    await depositPublic(rpcProvider, "APrivateKey1zkpBz6J75Ndv4MwcFb6pccC1teFfMTb6BNNMwLkssp1xcH7", 10000000000000, "aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc");
}
async function testInstantWithdraw() {
    const mappingValues = [
    ...
    const rpcProvider = new TestRpcProvider(mappingValues);
    await instantWithdraw(rpcProvider, "APrivateKey1zkpBz6J75Ndv4MwcFb6pccC1teFfMTb6BNNMwLkssp1xcH7", 100000000);
}
await testInstantWithdraw();
