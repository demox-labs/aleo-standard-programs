...
export async function authorizeTransaction(aleoPrivateKey, programCode, functionName, inputs, feeCredits, feeRecord, imports) {
    const authJson = await ProgramManager.authorize_transaction(aleoPrivateKey, programCode, functionName, inputs, feeCredits, feeRecord, imports);
