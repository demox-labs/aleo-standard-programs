...
export class delegator3Program {
  ...
  address: string = 'delegator3.aleo';
  block: {
    height: bigint;
  } = { height: BigInt(0) };
  // params
  ...
  //program delegator3.aleo {// There are 4 potential states for a delegator:
  ...
  bond(validator: string, amount: bigint) {
    ...
    this.credits.caller = 'delegator3.aleo';
    this.credits.bond_public(validator, 'delegator3.aleo', amount);
  ...
  finalize_bond(validator: string) {
    ...
    let balance: bigint = BigInt.asUintN(
      64,
      this.credits.account.get('delegator3.aleo')!
    );
  ...
  unbond(amount: bigint) {
    ...
    this.credits.signer = this.signer;
    this.credits.caller = 'delegator3.aleo';
    this.credits.unbond_public('delegator3.aleo', amount);
  ...
  finalize_unbond() {
    ...
    let bonded: boolean = this.credits.bonded.has('delegator3.aleo');
  ...
  ban_validator(validator: string) {
    ...
    this.validator_oracle.caller = 'delegator3.aleo';
