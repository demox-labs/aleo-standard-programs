...
export class pondo_oracleProgram {
  ...
  finalize_update_data(
    ...
    let boost: validator_boost = this.validator_boosting.get(existing_validator_datum.validator) || { epoch: BigInt("0"), boost_amount: BigInt("0") };
    ...
    let datum_0: validator_datum = this.validator_data.get(top_validators_addresses[0]) || default_validator_datum;
    let datum_1: validator_datum = this.validator_data.get(top_validators_addresses[1]) || default_validator_datum;
    let datum_2: validator_datum = this.validator_data.get(top_validators_addresses[2]) || default_validator_datum;
    let datum_3: validator_datum = this.validator_data.get(top_validators_addresses[3]) || default_validator_datum;
    let datum_4: validator_datum = this.validator_data.get(top_validators_addresses[4]) || default_validator_datum;
    let datum_5: validator_datum = this.validator_data.get(top_validators_addresses[5]) || default_validator_datum;
    let datum_6: validator_datum = this.validator_data.get(top_validators_addresses[6]) || default_validator_datum;
    let datum_7: validator_datum = this.validator_data.get(top_validators_addresses[7]) || default_validator_datum;
    let datum_8: validator_datum = this.validator_data.get(top_validators_addresses[8]) || default_validator_datum;
    let datum_9: validator_datum = this.validator_data.get(top_validators_addresses[9]) || default_validator_datum;
  ...
  finalize_boost_validator(
    ...
    let current_boost: validator_boost = this.validator_boosting.get(validator) || { epoch: BigInt("0"), boost_amount: BigInt("0") };
