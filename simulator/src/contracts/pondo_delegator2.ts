...
export class delegator2Program {
  ...
  address: string = 'delegator2.aleo';
  block: {
    height: bigint;
  } = { height: BigInt(0) };
  // params
  ...
  //program delegator2.aleo {// There are 4 potential states for a delegator:
  ...
  bond(validator: string, amount: bigint) {
    ...
    this.credits.bond_public(validator, 'delegator2.aleo', amount);
  ...
  finalize_bond(validator: string) {
    ...
    let balance: bigint = BigInt.asUintN(
      64,
      this.credits.account.get('delegator2.aleo')!
    );
  ...
  unbond(amount: bigint) {
    ...
    this.credits.signer = this.signer;
    this.credits.caller = 'delegator2.aleo';
    this.credits.unbond_public('delegator2.aleo', amount);
  ...
  finalize_unbond() {
    ...
    let bonded: boolean = this.credits.bonded.has('delegator2.aleo');
  ...
  ban_validator(validator: string) {
    ...
    this.validator_oracle.caller = 'delegator2.aleo';
